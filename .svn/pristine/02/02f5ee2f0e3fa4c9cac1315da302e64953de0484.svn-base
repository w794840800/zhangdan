 ...
 * module: 游戏详情界面
 */
public class GameDetailActivity extends MvpActivity<CommonPresenter> implements CommonView<ReimDetailModel> {
    @Bind(R.id.tv_title)
    TextView tvTitle;
    @Bind(R.id.toolbar)
    Toolbar toolbar;
    ...
    protected void onResume() {
        super.onResume();
        request(id);
        StatService.onPageStart(mActivity,"游戏详情页面");
    }

    @Override
    protected void onPause() {
        super.onPause();
        StatService.onPageEnd(mActivity,"游戏详情页面");
    }
    ...
    void request(String id) {
        ...
        mvpPresenter.getgame(encMsg, signMsg, "2", spUtils.getSecretKeyId());
    }
