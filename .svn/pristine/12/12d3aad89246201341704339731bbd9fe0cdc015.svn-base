...
import com.beidou.ybz.accountbook.adapter.AdapterBankcard;
 ...
 * module: 银行卡界面
 */
public class BankCardActivity extends MvpActivity<CommonPresenter> implements CommonView<BankcardListModel>, OtherView<SercetKeyOverdueModel> {
    ...
    private AdapterBankcard mAdapter;
    private List<BankcardListModel.BodyBean.ProListBean> proListBeanlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new AdapterBankcard(R.layout.bankcard_item, null);
        ...
        mAdapter.setOnItemLongClickListener(new BaseQuickAdapter.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(BaseQuickAdapter adapter, View view, int position) {
                alertDialogUtils.setMessage("确定要删除" + proListBeanlist.get(position).getBankId() + "？");
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent in = new Intent(mActivity, BankcardDetailActivity.class);
                in.putExtra("id", proListBeanlist.get(position).getId());
                in.putExtra("name", proListBeanlist.get(position).getBankName());
                in.putExtra("logo", proListBeanlist.get(position).getBanklogo());
                startActivity(in);
        ...
        alertDialogUtils.setOnDialogClickListener(new DialogClickListener() {
            ...
            public void clickYes(int which) {
                StatService.onEvent(mActivity, "点击银行卡列表任一删除按钮", "删除银行卡具体资产", 1);
    ...
    protected void onResume() {
        super.onResume();
        request();
        StatService.onPageStart(mActivity, "银行卡列表页面");
    }

    @Override
    protected void onPause() {
        super.onPause();
        StatService.onPageEnd(mActivity, "银行卡列表页面");
    }
    ...
    void request() {
        ...
        mvpPresenter.getbankcardlist(encMsg, signMsg, "2", spUtils.getSecretKeyId());
        if (count == 0) {
            mEmptyView.loading();
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvAddAssets:
                StatService.onEvent(mActivity, "银行卡列表页点击新增", "新增银行卡", 1);
    ...
    @Override
    public void getDataSuccess(BankcardListModel model) {
        try {
    ...
    void del(String id) {
        ...
        mvpPresenter.delbankcard(encMsg, signMsg, "2", spUtils.getSecretKeyId());
    }
