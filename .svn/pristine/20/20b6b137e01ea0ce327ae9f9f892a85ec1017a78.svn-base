 ...
 * 银行卡列表adapter
 */
public class AdapterSupportBank extends BaseQuickAdapter<SupportBankModel.BodyBean.CommListBean,BaseViewHolder> {//AccountIndexModel.BodyBean.FieldViewAmountListBean
        String bankType  ;
        private int mPosition = -1;
    public AdapterSupportBank(int layoutResId, List data) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, SupportBankModel.BodyBean.CommListBean item) {
