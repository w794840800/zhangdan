...
public class ArrearsDetailActivity extends MvpActivity<CommonPresenter> implements CommonView<ArrearsDetailModel>, OtherView<SercetKeyOverdueModel> {
    ...
    protected void onResume() {
        ...
        StatService.onPageStart(mActivity, "欠款详情页面");
    }

    @Override
    protected void onPause() {
        super.onPause();
        StatService.onPageEnd(mActivity, "欠款详情页面");
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvAddAssets:
                StatService.onEvent(mActivity, "任一欠款详情页点击欠款已还清按钮", "欠款还清标记使用情况", 1);
