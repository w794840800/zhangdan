...
/**
 * Author: xu.yang on 2017/12/18
 * QQ:754444814
 * E-mail:754444814@qq.com
 * module:Bank card input TextWatcher 4 grouping input :
 * http://blog.csdn.net/cc_want/article/details/75070926
 */
public class BankCardTextWatcher implements TextWatcher { //default max length = 21 + 5 space
    private static final int DEFAULT_MAX_LENGTH = 25 + 6;//21 + 5
    //max input length
