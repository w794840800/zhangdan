...
import com.beidou.ybz.accountbook.adapter.AdapterLoan;
 ...
 * module: 借款界面
 */
public class LoanActivity extends MvpActivity<CommonPresenter> implements CommonView<LoanlistModel>, OtherView<SercetKeyOverdueModel> {
    ...
    private List<LoanlistModel.BodyBean.ProListBean> proListBeanList;
    private AdapterLoan mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAddAssets.setText("+  新建借出");
        tvTitle.setText("借款");
        tvMingcheng.setText("借出金额(元)");
        ...
        mAdapter = new AdapterLoan(R.layout.arrearslist_item, null);
        rv.setAdapter(mAdapter);

        tvName.setText("借款人");
        tvValue.setText("借款金额");
        ...
        mAdapter.setOnItemLongClickListener(new BaseQuickAdapter.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(BaseQuickAdapter adapter, View view, int position) {
                alertDialogUtils.setMessage("确定要删除" + proListBeanList.get(position).getLoanName() + "？");
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent in = new Intent(mActivity, LoanDetailActivity.class);
                in.putExtra("id", proListBeanList.get(position).getId());
                in.putExtra("name", proListBeanList.get(position).getLoanName());
                startActivity(in);
        ...
        alertDialogUtils.setOnDialogClickListener(new DialogClickListener() {
            ...
            public void clickYes(int which) {
                StatService.onEvent(mActivity,"点击借款列表任一删除按钮","删除借款具体资产",1);
    ...
    protected void onResume() {
        super.onResume();
        request();
        StatService.onPageStart(mActivity,"借款列表页面");
    }

    @Override
    protected void onPause() {
        super.onPause();
        StatService.onPageEnd(mActivity,"借款列表页面");
    }
    ...
    void request() {
        ...
        mvpPresenter.getloanassetlist(encMsg, signMsg, "2", spUtils.getSecretKeyId());
        if (count == 0) {
            mEmptyView.loading();
        }
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvAddAssets:
                StatService.onEvent(mActivity,"借款列表页点击新增","新增借款",1);
                Intent in = new Intent(mActivity, AddLoan.class);
    ...
    @Override
    public void getDataSuccess(LoanlistModel model) {
        count++;
        try {
            ...
            if (proListBeanList != null && proListBeanList.size() > 0) {
                ...
                mEmptyView.setEmptyText("还没有借出产品哦～");
                mEmptyView.empty();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    void del(String id) {
        ...
        mvpPresenter.delloanasset(encMsg, signMsg, "2", spUtils.getSecretKeyId());
    }
