 ...
 * 股权列表adapter
 */
public class AdapterEquity extends BaseQuickAdapter<EquityModel.BodyBean.ProListBean,BaseViewHolder> {

    public AdapterEquity(int layoutResId, List data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, EquityModel.BodyBean.ProListBean item) {
        try {
