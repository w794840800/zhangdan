...
public class PinEntryEditText extends EditText {
    ...
    protected float mSpace = 0;//16; //24 dp by default, space between the lines
    protected float mCharSize;
    protected float mNumChars = 4;
    protected float mTextBottomPadding = 4; //8dp by default, height of the text from our lines
