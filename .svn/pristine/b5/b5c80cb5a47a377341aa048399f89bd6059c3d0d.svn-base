...
/** 供PasswordEditText继承，新的ClearEditText继承有问题
 * Created by bob on 2015/11/20.
 */
public class ClearEditText1 extends AppCompatEditText {
    ...
    public ClearEditText1(final Context context) {
        super(context);
        init(context);
    }

    public ClearEditText1(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ClearEditText1(final Context context, final AttributeSet attrs, final int defStyleAttr) {
