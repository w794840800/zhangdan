...
public class MaterialDialog {
    ...
    public MaterialDialog setExtraMessage(CharSequence extraMessage) {
    ...
    public MaterialDialog setHuizhangCloseButton(String text,final View.OnClickListener listener) {
        this.hText = text;
        this.nListener = listener;
        return this;
    }
