 ...
 * module: 互联网账号详情界面
 */
public class InternetDetailActivity extends MvpActivity<CommonPresenter> implements CommonView<InternetDetailModel> {
    @Bind(R.id.tv_title)
    TextView tvTitle;
    @Bind(R.id.toolbar)
    Toolbar toolbar;
    ...
    protected void onResume() {
        super.onResume();
        request(id);
        StatService.onPageStart(mActivity,"互联网账号详情页面");
    }
    @Override
    protected void onPause() {
        super.onPause();
        StatService.onPageEnd(mActivity,"互联网账号详情页面");
    }
    ...
    void request(String id) {
        ...
        mvpPresenter.getwebaccount(encMsg, signMsg, "2", spUtils.getSecretKeyId());
    }
    ...
    @Override
    public void getDataSuccess(InternetDetailModel model) {
