...
import com.beidou.ybz.accountbook.adapter.AdapterReimburse;
 ...
 * module: 报销界面
 */
public class ReimbursementActivity extends MvpActivity<CommonPresenter> implements CommonView<ReimburseListModel>, OtherView<SercetKeyOverdueModel> {
    ...
    private List<ReimburseListModel.BodyBean.ProListBean> proListBeanList;
    private AdapterReimburse mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAddAssets.setText("+  新建报销");
        tvTitle.setText("报销");
        tvMingcheng.setText("待报销金额(元)");
        ...
        mAdapter = new AdapterReimburse(R.layout.overseaslist_item, null);
        rv.setAdapter(mAdapter);

        tvName.setText("报销人");
        tvValue.setText("报销金额");
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent in = new Intent(mActivity, ReimbursementDetailActivity.class);
        ...
        alertDialogUtils.setOnDialogClickListener(new DialogClickListener() {
            ...
            public void clickYes(int which) {
                StatService.onEvent(mActivity,"点击报销列表任一删除按钮","删除报销具体资产",1);
    ...
    protected void onResume() {
        super.onResume();
        request();
        StatService.onPageStart(mActivity,"报销列表页面");
    }

    @Override
    protected void onPause() {
        super.onPause();
        StatService.onPageEnd(mActivity,"报销列表页面");
    }
    ...
    void request() {
        ...
        mvpPresenter.getexpenseaccountlist(encMsg, signMsg, "2", spUtils.getSecretKeyId());
        if (count == 0) {
            mEmptyView.loading();
        }
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvAddAssets:
                StatService.onEvent(mActivity,"报销列表页点击新增","新增报销",1);
    ...
    @Override
    public void getDataSuccess(ReimburseListModel model) {
        count++;
        try {
    ...
    void del(String id) {
        ...
        mvpPresenter.delexpenseaccount(encMsg, signMsg, "2", spUtils.getSecretKeyId());
    }
