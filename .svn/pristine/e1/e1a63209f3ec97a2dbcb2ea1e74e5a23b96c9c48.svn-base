 ...
 * module:添加海外房产请求model
 */
public class AddOverseasRequestModel {

    private String userNo;//用户id
    private String homeName;//名称
    private String amount;//估值
    private String area;//面积

    private String unit;// 面积单位;
    ...
    private String positionNumber;//股票持仓数
    private String brokerName ;//股票券商名称


    //保险
    private String productName;// 名称
    private String yearBonus;//年金

    //股票所搜关键字
    private String words;

    //欠款
    private String arrearsName;//借款名称
    private String loanTime;//借款时间
    private String returnTime;//归还时间
    private String arrearsStatus;//欠款状态
    ...
    //互联网账号
    private String accountNo;//互联网账号

    //固定收益
    private String yearIncome;//年化收益

    //预付卡
    private String times;//可用次数
    ...
    //徽章
    private String badgeDetailId;//徽章详情id
    ...
    public String getNewMessageCode() {
        return newMessageCode;
    }

    public void setNewMessageCode(String newMessageCode) {
        this.newMessageCode = newMessageCode;
    }

    //活期理财
    private String currentType;// 宝宝类型

    //银行卡
    private String bankNo;// 卡号
    private String bankId;// 所属银行号
...
//    }
     ...
     * 三方登录解除绑定接口
     */
    private String thirdAcctChannel;
    private String thirdAcctType;

    public String getThirdAcctChannel() {
        return thirdAcctChannel;
    }

    public void setThirdAcctChannel(String thirdAcctChannel) {
        this.thirdAcctChannel = thirdAcctChannel;
    }
