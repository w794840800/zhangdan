...
import com.beidou.ybz.accountbook.adapter.AdapterCredit;
 ...
 * module: 贷款界面
 */
public class CreditActivity extends MvpActivity<CommonPresenter> implements CommonView<CreditModel>, OtherView<SercetKeyOverdueModel> {
    ...
    private List<CreditModel.BodyBean.ProListBean> proListBeanList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAddAssets.setText("+  新建贷款");
        tvTitle.setText("贷款");
        tvMingcheng.setText("累计贷款(元)");

        tvName.setText("贷款原因");
        tvValue.setText("总计应还");
        ...
        mAdapter = new AdapterCredit(R.layout.overseaslist_item, null);
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent in = new Intent(mActivity, CreditDetailActivity.class);
        ...
        alertDialogUtils.setOnDialogClickListener(new DialogClickListener() {
            ...
            public void clickYes(int which) {
                StatService.onEvent(mActivity,"点击贷款列表任一删除按钮","删除贷款具体资产",1);
    ...
    protected void onResume() {
        super.onResume();
        request();
        StatService.onPageStart(mActivity, "贷款列表页面");
    }

    @Override
    protected void onPause() {
        super.onPause();
        StatService.onPageEnd(mActivity, "贷款列表页面");
    }
    ...
    void request() {
        ...
        mvpPresenter.getCreditList(encMsg, signMsg, "2", spUtils.getSecretKeyId());
        if (count == 0) {
            mEmptyView.loading();
        }
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvAddAssets:
                StatService.onEvent(mActivity,"贷款列表页点击新增","新增贷款",1);
    ...
    @Override
    public void getDataSuccess(CreditModel model) {
        count++;
        try {
            ...
            if (proListBeanList != null && proListBeanList.size() > 0) {
                ...
                mEmptyView.setEmptyText("还没有贷款产品哦～");
                mEmptyView.empty();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    void del(String id) {
        ...
        mvpPresenter.delcreditasset(encMsg, signMsg, "2", spUtils.getSecretKeyId());
    }
