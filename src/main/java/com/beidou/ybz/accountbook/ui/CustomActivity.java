 ...
 * module: 其他分类界面
 */
public class CustomActivity extends MvpActivity<CommonPresenter> implements CommonView<CustomListModel>, OtherView<SercetKeyOverdueModel> {
    ...
    private List<CustomListModel.BodyBean.ProListBean> proListBeanList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new AdapterCustom(R.layout.overseaslist_item, null);
        rv.setAdapter(mAdapter);

        llZichan.setVisibility(View.GONE);
        tvName.setText("资产名称");
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                in.putExtra("name", proListBeanList.get(position).getName());
                startActivity(in);
        ...
        alertDialogUtils.setOnDialogClickListener(new DialogClickListener() {
            ...
            public void clickYes(int which) {
                StatService.onEvent(mActivity, "点击其他列表任一删除按钮", "删除其他具体资产", 1);
    ...
    protected void onResume() {
        super.onResume();
        request();
        StatService.onPageStart(mActivity, "其他分类列表页面");
    }

    @Override
    protected void onPause() {
        super.onPause();
        StatService.onPageEnd(mActivity, "其他分类列表页面");
    }
    ...
    void request() {
        ...
        mvpPresenter.getcustomassetlist(encMsg, signMsg, "2", spUtils.getSecretKeyId());
        if (count == 0) {
            mEmptyView.loading();
        }
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvAddAssets:
                StatService.onEvent(mActivity, "其他列表页点击新增", "新增其他", 1);
    ...
    @Override
    public void getDataSuccess(CustomListModel model) {
        count++;
        try {
            ...
            if (proListBeanList != null && proListBeanList.size() > 0) {
                ...
                mEmptyView.setEmptyText("还没有记录哦～");
                mEmptyView.empty();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    void del(String id) {
        ...
        mvpPresenter.delcustomasset(encMsg, signMsg, "2", spUtils.getSecretKeyId());
    }
