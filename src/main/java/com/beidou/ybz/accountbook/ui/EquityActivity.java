 ...
 * module: 股权界面
 */
public class EquityActivity extends MvpActivity<CommonPresenter> implements CommonView<EquityModel>, OtherView<SercetKeyOverdueModel> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent in = new Intent(mActivity, EquityDetailActivity.class);
        ...
        alertDialogUtils.setOnDialogClickListener(new DialogClickListener() {
            ...
            public void clickYes(int which) {
                StatService.onEvent(mActivity,"点击股权列表任一删除按钮","删除股权具体资产",1);
    ...
    protected void onResume() {
        ...
        StatService.onPageStart(mActivity, "股权列表页面");
    }

    @Override
    protected void onPause() {
        super.onPause();
        StatService.onPageEnd(mActivity, "股权列表页面");
    }
    ...
    void request() {
        ...
        mvpPresenter.getEquityList(encMsg, signMsg, "2", spUtils.getSecretKeyId());
        if (count == 0) {
            mEmptyView.loading();
        }
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvAddAssets:
                StatService.onEvent(mActivity,"股权列表页点击新增","新增股权",1);
    ...
    public void getDataSuccess(EquityModel model) {
        ...
        try {
            ...
            if (proListBeanList != null && proListBeanList.size() > 0) {
                ...
                mEmptyView.setEmptyText("还没有股权产品哦～");
                mEmptyView.empty();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    void del(String id) {
        ...
        mvpPresenter.delequityassets(encMsg, signMsg, "2", spUtils.getSecretKeyId());
    }
