...
import com.beidou.ybz.accountbook.adapter.AdapterInternet;
 ...
 * module: 互联网账号界面
 */
public class InternetActivity extends MvpActivity<CommonPresenter> implements CommonView<InternetListModel>, OtherView<SercetKeyOverdueModel> {
    ...
    private List<InternetListModel.BodyBean.ProListBean> proListBeanList;
    private AdapterInternet mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAddAssets.setText("+  新建互联网账号");
        tvTitle.setText("互联网账号");
        tvMingcheng.setText("估值总计(元)");
        ...
        mAdapter = new AdapterInternet(R.layout.overseaslist_item, null);
        rv.setAdapter(mAdapter);

        tvName.setText("账号名称");
        tvValue.setText("资产估值");
        ...
        mAdapter.setOnItemLongClickListener(new BaseQuickAdapter.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(BaseQuickAdapter adapter, View view, int position) {
                alertDialogUtils.setMessage("确定要删除" + proListBeanList.get(position).getAccountNo() + "？");
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent in = new Intent(mActivity, InternetDetailActivity.class);
                in.putExtra("id", proListBeanList.get(position).getId());
                in.putExtra("name", proListBeanList.get(position).getAccountNo());
                startActivity(in);
        ...
        alertDialogUtils.setOnDialogClickListener(new DialogClickListener() {
            ...
            public void clickYes(int which) {
                StatService.onEvent(mActivity,"点击账号列表任一删除按钮","删除账号具体资产",1);
    ...
    protected void onResume() {
        super.onResume();
        request();
        StatService.onPageStart(mActivity,"互联网账号列表页面");
    }
    @Override
    protected void onPause() {
        super.onPause();
        StatService.onPageEnd(mActivity,"互联网账号列表页面");
    }
    ...
    void request() {
        ...
        mvpPresenter.getwebaccountlist(encMsg, signMsg, "2", spUtils.getSecretKeyId());
        if (count == 0) {
            mEmptyView.loading();
        }
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvAddAssets:
                StatService.onEvent(mActivity,"账号列表页点击新增","新增账号",1);
                Intent in = new Intent(mActivity, AddInternetAccount.class);
    ...
    @Override
    public void getDataSuccess(InternetListModel model) {
        count++;
        try {
            ...
            if (proListBeanList != null && proListBeanList.size() > 0) {
                ...
                mEmptyView.setEmptyText("还没有互联网账号哦～");
                mEmptyView.empty();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    void del(String id) {
        ...
        mvpPresenter.delwebaccount(encMsg, signMsg, "2", spUtils.getSecretKeyId());
    }
