 ...
 * 链接在本页面生成
 */
public class X5Web2Activity extends BaseActivity {
    /**
...
//                    }
                    ...
                    if (spUtils.getIsLogin()) {
                        ...
                        ActivityUtils.startActivityRightIn(X5Web2Activity.this, LoginActivity.class);
                    }
                }else {
                    view.loadUrl(url);
...
//            mWebView.loadUrl(url);
    ...
    private void openImageChooserActivity() {
        ...
        RxPermissions.getInstance(X5Web2Activity.this)
