...
//				.getDrawable(R.drawable.color_progressbar));
    ...
    void splitString(String ss) {
        Map<String, String> paramMap = TestUrl.urlSplitIgnoreCase(ss);
...
//
        LogUtils.loge("title:" + shareModel.getTitle() + "\nintro:" + shareModel.getContent() + "\nimage:" + shareModel.getImgurl());
    }
...
//                    showMoreWindow(mWebView);
                    ...
                    if (spUtils.getIsLogin()) {
                        ...
                        ActivityUtils.startActivityRightIn(X5WebActivity.this, LoginActivity.class);
                    }
                } else {
                    view.loadUrl(url);
                    X5WebActivity.this.url = url;
