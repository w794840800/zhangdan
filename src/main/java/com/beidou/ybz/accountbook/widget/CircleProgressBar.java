...
public class CircleProgressBar extends ImageView {
    ...
    private static final int DEFAULT_CIRCLE_BG_LIGHT = R.color.colorGold;//0x00E78270;//0x338080FF;//0xFFFAFAFA;//0xFAFAFA;//#0x00E78270
    ...
    private int[] mColors = new int[]{R.color.colorGold};
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBackGroundColor = a.getColor(
                R.styleable.CircleProgressBar_mlpb_background_color, getResources().getColor(android.R.color.darker_gray));//DEFAULT_CIRCLE_BG_LIGHT

        mProgressColor = a.getColor(
                R.styleable.CircleProgressBar_mlpb_progress_color, getResources().getColor(DEFAULT_CIRCLE_BG_LIGHT));
